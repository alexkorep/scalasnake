...
/** @constructor */
function $h_LMain$Point() {
  /*<skip>*/
}
$h_LMain$Point.prototype = $c_LMain$Point.prototype;
$c_LMain$Point.prototype.draw__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__T__V = (function(ctx, color) {
  ctx.beginPath();
...
function $as_LMain$Point(obj) {
  return (((obj instanceof $c_LMain$Point) || (obj === null)) ? obj : $throwClassCastException(obj, "Main$Point"))
}
function $isArrayOf_LMain$Point(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LMain$Point)))
}
function $asArrayOf_LMain$Point(obj, depth) {
  return (($isArrayOf_LMain$Point(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "LMain$Point;", depth))
}
var $d_LMain$Point = new $TypeData().initClass({
  LMain$Point: 0
}, false, "Main$Point", {
  LMain$Point: 1,
  O: 1
});
$c_LMain$Point.prototype.$classData = $d_LMain$Point;
/** @constructor */
...
$c_sc_ArrayOps$.prototype.dropRight$extension__O__I__O = (function(this$, n) {
  var n$1 = (($m_sr_ScalaRunTime$().array_length__O__I(this$) - ((n > 0) ? n : 0)) | 0);
...
function $f_s_App__main__AT__V($thiz, args) {
  $thiz.LMain$__f_scala$App$$_args = args;
  var this$1 = $thiz.LMain$__f_scala$App$$initCode;
...
function $f_s_App__$init$__V($thiz) {
  ...
  $thiz.LMain$__f_executionStart = new $c_RTLong(lo, hi);
...
function $c_LMain$() {
  ...
  this.LMain$__f_SPEED_RATIO = 0.0;
  this.LMain$__f_INITIAL_SPEED = 0;
  this.LMain$__f_canvas = null;
  this.LMain$__f_ctx = null;
  this.LMain$__f_segments = null;
  this.LMain$__f_dir = 0;
  this.LMain$__f_aiming = false;
  ...
  var body = new $c_LMain$delayedInit$body(this);
  var this$1 = this.LMain$__f_scala$App$$initCode;
...
$c_LMain$.prototype.isFree__I__I__Z = (function(x, y) {
  var nonLocalReturnKey1 = $ct_O__(new $c_O());
  try {
    var xs = this.LMain$__f_segments;
    var f = ((this$2, x$1, y$1, nonLocalReturnKey1$1) => ((segment$2) => {
      var segment = $as_LMain$Point(segment$2);
      if (((segment.LMain$Point__f_x === x$1) && (segment.LMain$Point__f_y === y$1))) {
        throw new $c_sr_NonLocalReturnControl$mcZ$sp(nonLocalReturnKey1$1, false)
      }
    }))(this, x, y, nonLocalReturnKey1);
    var len = xs.u.length;
    var i = 0;
    if ((xs !== null)) {
      while ((i < len)) {
    ...
    if ((e instanceof $c_sr_NonLocalReturnControl)) {
      ...
      if ((ex.sr_NonLocalReturnControl__f_key === nonLocalReturnKey1)) {
        return ex.sr_NonLocalReturnControl$mcZ$sp__f_value$mcZ$sp
      } else {
        throw ex
      }
    } else {
...
$c_LMain$.prototype.placeRabbit__V = (function() {
  while (true) {
    var this$1 = this.LMain$__f_rnd;
    var n = this.LMain$__f_COLS;
    var x = this$1.s_util_Random__f_self.nextInt__I__I(n);
    var this$2 = this.LMain$__f_rnd;
    var n$1 = this.LMain$__f_ROWS;
    var y = this$2.s_util_Random__f_self.nextInt__I__I(n$1);
    if (this.isFree__I__I__Z(x, y)) {
      this.LMain$__f_rabbit = new $c_LMain$Point(x, y);
      return (void 0)
    }
  }
});
$c_LMain$.prototype.aboutToEatRabbit__Z = (function() {
  var newPoint = $as_LMain$Point(this.LMain$__f_getAimingPoint.apply__O());
  if (((newPoint.LMain$Point__f_x === this.LMain$__f_rabbit.LMain$Point__f_x) && (newPoint.LMain$Point__f_y === this.LMain$__f_rabbit.LMain$Point__f_y))) {
    return true
  };
  return false
});
...
$c_LMain$.prototype.newGame__F0 = (function() {
  return new $c_sjsr_AnonFunction0(((this$1) => (() => {
    $m_LMain$().LMain$__f_segments = new ($d_LMain$Point.getArrayOf().constr)(1);
...
$c_LMain$.prototype.delayedEndpoint$Main$1__V = (function() {
  ...
  this.LMain$__f_SPEED_RATIO = 0.95;
  this.LMain$__f_INITIAL_SPEED = 1000;
  this.LMain$__f_canvas = null;
  this.LMain$__f_ctx = null;
  this.LMain$__f_segments = null;
  this.LMain$__f_dir = 0;
  ...
  this.LMain$__f_getAimingPoint = new $c_sjsr_AnonFunction0(((this$2) => (() => {
    ...
    var newPoint$1 = null;
    var x1 = $m_LMain$().LMain$__f_dir;
    switch (x1) {
      case 0: {
        newPoint$1 = new $c_LMain$Point(head.LMain$Point__f_x, (((-1) + head.LMain$Point__f_y) | 0));
        break
      }
      case 1: {
        newPoint$1 = new $c_LMain$Point((((-1) + head.LMain$Point__f_x) | 0), head.LMain$Point__f_y);
        break
      }
      case 2: {
        newPoint$1 = new $c_LMain$Point(head.LMain$Point__f_x, ((1 + head.LMain$Point__f_y) | 0));
  ...
  this.LMain$__f_gameLoop = new $c_sjsr_AnonFunction0(((this$3) => (() => {
    var now = $uD(Date.now());
    var delta = (now - $m_LMain$().LMain$__f_prev);
    if ((delta >= $m_LMain$().LMain$__f_updateTime)) {
      $m_LMain$().update__V();
      $m_LMain$().render__V();
      $m_LMain$().LMain$__f_prev = now
    }
  }))(this));
  var this$4 = this.createCanvas__F0();
  this$4.apply__O();
  var this$5 = this.newGame__F0();
  this$5.apply__O();
...
/** @constructor */
function $c_LMain$delayedInit$body(outer) {
  this.LMain$delayedInit$body__f_$outer = null;
  if ((outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.LMain$delayedInit$body__f_$outer = outer
  }
}
...
$c_LMain$delayedInit$body.prototype.apply__O = (function() {
  this.LMain$delayedInit$body__f_$outer.delayedEndpoint$Main$1__V()
});
...
function $p_scm_ArrayBuffer$__growArray$1__J__I__I__AO__AO($thiz, arrayLength$1, n$1, end$1, array$1) {
  var lo = arrayLength$1.RTLong__f_lo;
  var lo$1 = (lo << 1);
  var hi = (((lo >>> 31) | 0) | (arrayLength$1.RTLong__f_hi << 1));
  ...
  while (true) {
    ...
    if (((hi$2 === bhi) ? (((-2147483648) ^ n$1) > ((-2147483648) ^ b__lo)) : (hi$2 > bhi))) {
      ...
      var lo$3 = this$4__lo;
      var lo$4 = (lo$3 << 1);
      var hi$3 = (((lo$3 >>> 31) | 0) | (this$4__hi << 1));
      var $$x1__lo = lo$4;
      var $$x1__hi = hi$3;
      newSize__lo = $$x1__lo;
      newSize__hi = $$x1__hi
  ...
  $m_s_Array$().copy__O__I__O__I__I__V(array$1, 0, newArray, 0, end$1);
  return newArray
}
/** @constructor */
...
$c_scm_ListBuffer.prototype.addAll__sc_IterableOnce__scm_ListBuffer = (function(xs) {
  if ((xs === this)) {
    if ((this.scm_ListBuffer__f_len > 0)) {
      $p_scm_ListBuffer__ensureUnaliased__V(this);
      var this$2 = new $c_scm_ListBuffer();
      var copy = this$2.addAll__sc_IterableOnce__scm_ListBuffer(this);
      this.scm_ListBuffer__f_last0.sci_$colon$colon__f_next = copy.scm_ListBuffer__f_first;
      this.scm_ListBuffer__f_last0 = copy.scm_ListBuffer__f_last0;
      this.scm_ListBuffer__f_len = (this.scm_ListBuffer__f_len << 1)
    }
  } else {
    var it = xs.iterator__sc_Iterator();
    if (it.hasNext__Z()) {
